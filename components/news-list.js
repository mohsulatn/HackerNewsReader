...
var NewsList = React.createClass({
    ...
    componentDidMount: function() {
        ...
        AsyncStorage.getItem('news_list').then((news_items_str) => {
            ...
            if(news_items != null){
                ...
                AsyncStorage.getItem('time').then((time_str) => {
                    ...
                    if(diff_days > 0){
                        ...
                        this.updateNewsListUI(news_items);
                    }
    ...
    viewPage: function(url){
        this.props.navigator.push({name: 'news_details', url: url});
    },

    updateNewsListUI: function(news_items){
    ...
    updateNewsItemDB: function(news_items){
        ...
        if(news_items.length == TOTAL_NEWS_ITEMS){
            AsyncStorage.setItem('news_list', JSON.stringify(news_items));
        }
